...
export class DisplayElement {
   ...
   * @param {Object} p
   * @param {HTMLElement|String} p.element An existing element, or HTML string to be converted to element. Becomes `this.dom`.
   * @param {Boolean} p.hide Default true, you must .show() elements in order to see them.
   * @param {String} p.display Default 'flex'
   * @param {HTMLElement} p.parent Parent element, triggers appendChild (optional)
   */
