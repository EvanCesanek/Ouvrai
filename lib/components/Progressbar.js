...
/**
 * Class representing a progress bar. Includes an associated DisplayElement inside the 'footer' element.
...
export class Progressbar extends DisplayElement {
  ...
  constructor() {
    let html = `
    <div id="progressbar-container" class="component-div">
      <span
        >Time Elapsed: <label id="minutes">00</label>:<label id="seconds"
          >00</label
        ><br
      /></span>
      <div id="progressbar-outer" class="component-div">
