...
export class XRInterface extends Block {
   ...
   * @param {string|boolean} instructions Multi-line string; set false to hide instructions panel
   * @param {boolean} buttons Set false to hide buttons panel
   * @param {string} nextButtonState 'disabled', 'idle', 'hover', 'selected', or other; see `XRButton.setupState()`
   * @param {string} backButtonState see `nextButtonState`
   */
  edit({
    title,
    instructions,
