 ...
 * @param {number|false} p.distanceThresh Max distance (default 1 cm)
 * @param {number|false} p.angleThresh Max angular distance around `axis` (default 0.0873 radians =~ 5 degrees)
